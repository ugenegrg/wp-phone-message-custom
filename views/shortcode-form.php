...
if ( ! empty( $days ) ) { // do only if there are days (today or tomorrow) checked in backend.
    ...
    <div class="timepicker" data-post="<?php the_ID(); ?>"
        ...
        <select class="timepicker__day" name="timepicker__day" id="timepicker__day" required>
        ...
        <select class="timepicker__time" name="timepicker__time" id="timepicker__time" required>
